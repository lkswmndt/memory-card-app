...
question_list.append(Question('The USA official language','English','Spanish','None','French'))
question_list.append(Question('The capital city of The UK','London','Edinburgh','Birmingham','Manchester'))
question_list.append(Question('The capital city of Indonesia','Jakarta','Bandung','Bali','Surabaya'))
app = QApplication([])
